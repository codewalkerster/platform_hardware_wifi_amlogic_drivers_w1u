...
//AML_CATEGORY_BTM
enum WIFINET_BTM_ACTION
{
    WIFINET_ACTION_BTM_REQ = 7,
    WIFINET_ACTION_BTM_RSP = 8,
};

enum WIFINET_BTM_STATUS
{
    WIFINET_BTM_STATUS_INIT= 0,
    WIFINET_BTM_STATUS_REQ = 1,
    WIFINET_BTM_STATUS_RSP = 2,
    WIFINET_BTM_STATUS_ONGOING = 3,
    WIFINET_BTM_STATUS_DONE = 4,
};
