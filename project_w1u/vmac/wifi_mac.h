...
typedef unsigned int wifi_mac_recovery_flags;
...
#define WIFINET_RECOVERY_CHECK_ONCE (BIT(WIFINET_RECOVERY_SRC_PAGE_ERROR) | BIT(WIFINET_RECOVERY_SRC_WAKE_FAIL)\
                                     | BIT(WIFINET_RECOVERY_SRC_CMD_CRASH) | BIT(WIFINET_RECOVERY_SRC_SDIO_TIMEOUT) | BIT(WIFINET_RECOVERY_SRC_BT_REQ))
